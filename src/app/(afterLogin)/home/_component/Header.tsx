...
export default function Header() {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm p-4 border-b border-gray-200 shrink-0">
      <div className="flex justify-between items-center p-15">
        <div className="flex justify-normal gap-2">
          <div className="flex items-center gap-3">
            ...
            {/*<span className="text-base font-medium text-purple-800 animate-pulse">Master </span>*/}
