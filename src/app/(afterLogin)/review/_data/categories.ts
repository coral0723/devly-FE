export const categories = [
  ...
  { study: 'word', name: '용어', style: 'bg-emerald-100 border border-emerald-600 text-emerald-600' },
  ...
  { study: 'interview', name: '면접', style: 'bg-orange-100 border border-orange-600 text-orange-600' },
];